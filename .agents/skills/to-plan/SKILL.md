...
The PRD should already be in the conversation. If it isn't, ask the user to paste it or point you to the file. If it's a GitHub issue, fetch it with `gh issue view <number>`.
